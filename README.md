...
<!-- shipped starts -->
- **[Provenance-First-Wiki](https://github.com/AbleVarghese/Provenance-First-Wiki)**: Why the LLM Wiki pattern breaks past 1,000 files, and the five… <sub>(2026-08-09)</sub>
...
<sub>*Auto-generated 2026-08-10 by [update_readme.py](scripts/update_readme.py). Derived, never hand-edited.*</sub>
<!-- shipped ends -->
