...
#   6. refreshes recently-shipped section from GitHub activity
#   7. syncs the GitHub repo description
#
...
echo "==> 3/7 running the audit"
python3 docs/forensics.py "$MAP" docs/forensics.json >/dev/null

echo "==> 4/7 regenerating assets"
python3 scripts/gen_assets.py

echo "==> 5/7 syncing figures"
